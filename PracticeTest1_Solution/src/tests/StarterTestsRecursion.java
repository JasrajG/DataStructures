...
public class StarterTestsRecursion {
	...
	@Test
	public void test_getAllSubsetsAlt_0() {
		RecursiveUtilities util = new RecursiveUtilities();
		/*
		 * Given as input an ArrayList treated as a set, 
		 * 	return the set of all (empty and non-empty) subsets.
		 ...
		 * Output: {<>}
		 */
		HashSet<ArrayList<Integer>> subsets = util.getAllSubsetsAlt(new ArrayList<Integer>());
		assertTrue(subsets.size() == 1);
	...
	@Test
	public void test_getAllSubsetsAlt_1() {
		RecursiveUtilities util = new RecursiveUtilities();
		 ...
		 */
		HashSet<ArrayList<Integer>> subsets = 
				util.getAllSubsetsAlt(new ArrayList<Integer>(Arrays.asList(1)));
		assertTrue(subsets.size() == 2);
	...
	@Test
	public void test_getAllSubsetsAlt_2() {
		RecursiveUtilities util = new RecursiveUtilities();
		 ...
		 */
		HashSet<ArrayList<Integer>> subsets = 
				util.getAllSubsetsAlt(new ArrayList<Integer>(Arrays.asList(1, 2)));
		assertTrue(subsets.size() == 4);
	...
	@Test
	public void test_getAllSubsetsAlt_3() {
		RecursiveUtilities util = new RecursiveUtilities();
		 ...
		 */
		HashSet<ArrayList<Integer>> subsets = 
				util.getAllSubsetsAlt(new ArrayList<Integer>(Arrays.asList(1, 2, 3)));
		assertTrue(subsets.size() == 8);
