...
public class TestStringSLL {
	...
	@Test
	public void testSLL_removeFirst() {
		SinglyLinkedList list = new SinglyLinkedList();
		assertTrue(list.getSize() == 0);
		assertTrue(list.getFirst() == null);
		...
		list.removeFirst();
		assertTrue(list.getSize() == 2);
		assertEquals("Mark", list.getNodeAt(0).getElement());
		assertEquals("Tom", list.getNodeAt(1).getElement());
		
		list.removeFirst();
		assertTrue(list.getSize() == 1);
		assertEquals("Tom", list.getNodeAt(0).getElement());
